...
namespace programas_1
{
    class Program
    {
        public static void MostrarTitulos()
        {
            ...
            Console.Write("Se ingresa la cantidad de agua caida, en mílimetros día a día durante 6 o 7 dias.Se pide determinar el día de mayor lluvia, el de menor y el promedio ");
            Console.WriteLine();
